...
function createListElement(data) {
  ...
  // if(data.price < 0) {
  //   liEl.classList.add('expense')
  // } else {
  //   liEl.classList.add('income')
  // }
  // // List left
...
//Create - Crear Local Storage
//Read - Leer Local Storage
//Update - Actualizar Local Storage
//Delete - Eliminar Local Storage
